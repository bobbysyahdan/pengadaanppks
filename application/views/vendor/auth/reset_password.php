                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Silahkan isi password Akun Anda yang baru.</p>
                                <form class="auth-login-form mt-2" action="<?= base_url("/auth/resetPassword/$remember_token"); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge" id="confirm_password" type="password" name="confirm_password" placeholder="············" aria-describedby="password" tabindex="2" />
                                            <div class="input-group-append"><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span></div>
                                        </div>
                                        <small class="text-danger"><?= form_error('confirm_password') ?></small>
                                    </div>
                                    <button class="btn btn-primary btn-block" tabindex="4">Simpan</button>
                                </form>
