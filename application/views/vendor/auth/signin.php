                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?= base_url('app-assets/images/pages/login-v2-dark.svg') ?>" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <?php endif; ?>
                                <h2 class="card-title font-weight-bold mb-1">Pengadaan PPKS</h2>
                                <p class="card-text mb-2">Sudah punya akun? Silahkan Masuk Ke Akun Anda.</p>
                                <form class="auth-login-form mt-2" action="<?= base_url('/auth/signin'); ?>" method="POST">
                                    <div class="form-group">
                                        <label class="form-label" for="email">Email</label>
                                        <input class="form-control" id="email" type="text" name="email" placeholder="adibudi@example.com" aria-describedby="email" autofocus="" tabindex="1" />
                                        <small class="text-danger"><?= form_error('email') ?></small>
                                    </div>
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="password">Password</label><a href="<?= base_url('/auth/forgotPassword') ?>"><small>Lupa Password?</small></a>
                                        </div>
                                ...
                                <p class="text-center mt-2"><span>Belum punya akun? </span><a href="<?= base_url('/auth/signup') ?>"><span>&nbsp;Buat Akun Baru</span></a></p>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
