                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Kami akan mengirim link pembaharuan password Baru ke Email Akun Anda.</p>
                                <form class="auth-login-form mt-2" action="<?= base_url('/auth/forgotPassword'); ?>" method="POST">
                                    ...
                                    <button class="btn btn-primary btn-block" tabindex="4">Kirim</button>
                                </form>
