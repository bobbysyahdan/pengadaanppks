                                            ...
                                            <?php 
                                                ...
                                                if($this->session->userdata('id_mitra')){
                                                    ...
                                                    if($mitra_rekanan['status'] == 3){
                                                        $kode_kbli_mitra = explode(',', $mitra_rekanan['kode_kbli']); 
                                                        $kode_kbli = explode(',', $value['kode_kbli']);
                                                        $check = 0;
                                                        foreach($kode_kbli_mitra as $kkm) {
                                                            foreach($kode_kbli as $kk) {
                                                                if($kkm == $kk) { $check += 1; if($check == 1){ ?>
                                                                <tr>
                                                                    <td><?= $kkm ?></td>
                                                                    ...
                                                                    <td>
                                                                        <?php if($this->session->userdata('id_mitra')): ?>
                                                                            ...
                                                                            <?php endif; ?>
                                                                        <?php else: ?>
                                                                            Anda harus <a class="text-warning" href="<?= base_url('auth/signin') ?>">Masuk</a> atau <a class="text-warning" href="href="<?= base_url('auth/signin') ?>> Daftar </a>terlebih dahulu
                                                                        <?php endif; ?>
                                                                    </td>
                                                                </tr>
                                                                <?php
