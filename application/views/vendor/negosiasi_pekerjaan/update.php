                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url('/negosiasiPekerjaan'); ?>">Negosiasi</a></li>
                                    <li class="breadcrumb-item"><a href="<?= base_url("/negosiasiPekerjaan/detail/$nomor_penawaran"); ?>">Detail Penawaran</a></li>
                                    <li class="breadcrumb-item">Ubah Penawaran</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body mt-2">
                                <form action="<?= base_url("/negosiasiPekerjaan/update/$nomor_penawaran") ?>" name="form1" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <table class="table col-md-12 mt-2"> 
                                            <thead>
                                                ...
                                                foreach($penawaran as $key => $value): $jumlah_total_harga += $value['total_harga']; ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="harga_satuan_ps<?= $key ?>" id="harga_satuan_ps<?= $key ?>" class="form-control" placeholder="10000" value="<?= $value['harga_satuan_ps'] ?>" required readonly>
                                                        </div>
                                                    ...
                                                    <input type="hidden" name="jumlah<?= $key ?>" id="jumlah<?= $key ?>" class="form-control" value="<?= $value['jumlah'] ?>" readonly />
                                                    <td>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">Rp</span>
                                                            </div>
                                                            <input type="text" name="total_harga<?= $key ?>" id="total_harga<?= $key ?>" class="form-control" value="<?= $value['total_harga'] ?>" readonly/>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
    ...
    <script>
        ...
        function calc(){
            <?php foreach($penawaran as $key => $value): ?>
                    document.getElementById('total_harga<?= $key ?>').value = document.getElementById('harga_satuan<?= $key ?>').value * document.getElementById('jumlah<?= $key ?>').value;
                    var tj<?= $key ?> = parseInt(document.getElementById('total_harga<?= $key ?>').value);
            <?php endforeach; ?>
